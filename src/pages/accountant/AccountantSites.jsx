...
const AccountantSites = () => {
  ...
  // React Query data
  const { data: allSites = [], isLoading: sitesLoading } = useAccountantSites();
  const { data: allClients = [], isLoading: clientsLoading } = useAccountantClients();
  ...
  const clientOptions = useMemo(
    () => [
      {
        value: "all",
        label: `${t("accountant.allClients")} (${allSites.length})`,
      },
