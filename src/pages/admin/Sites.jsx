...
import { Plus, Edit, Trash2, Search, MapPin, Layers, ArrowRight } from 'lucide-react';
            ...
            >
              ...
              <div className="h-48 bg-gray-100 overflow-hidden relative flex-shrink-0">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all flex items-center justify-center pointer-events-none">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white rounded-lg px-4 py-2 flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-900">Manage Sections</span>
              ...
              <div className="p-6 space-y-3 flex-1 flex flex-col overflow-hidden">
                <div className="flex justify-between items-start flex-shrink-0">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ml-2 flex-shrink-0 ${getSiteTypeColor(site.siteType)}`}>
                    {site.siteType}
                  </span>
                </div>
                ...
                {/* Stats - Fixed */}
                <div className="grid grid-cols-3 gap-2 pt-3 border-t flex-shrink-0">
                ...
                <div className="flex-shrink-0 h-10 pt-2">
