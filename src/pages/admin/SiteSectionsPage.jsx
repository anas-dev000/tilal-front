        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-4 gap-4 pt-4 border-t border-gray-200">
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">{site.totalArea || 0}m²</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">{site.totalTasks || 0}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Completed</p>
              <p className="text-xl font-bold text-green-600">{site.completedTasks || 0}</p>
            </div>
          </div>

          {/* Location Info */}
          {site.location && (site.location.address || site.location.googleMapsLink) && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-gray-500 flex-shrink-0 mt-0.5" />
                <div className="flex-1">
                  {site.location.address && (
                    <p className="text-gray-700 mb-1">{site.location.address}</p>
                  )}
                  {site.location.city && (
                    <p className="text-sm text-gray-600">{site.location.city}</p>
                  )}
