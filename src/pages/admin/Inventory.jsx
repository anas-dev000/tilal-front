...
const Inventory = () => {
  ...
  const getStockStatus = (item) => {
    ...
    if (current === 0) return { label: 'Out of Stock', color: 'text-red-600', showAlert: true };
    if (current <= minimum) return { label: 'Low Stock', color: 'text-yellow-600', showAlert: true };
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-semibold text-red-900">
                تنبيه: {lowStockCount} {lowStockCount === 1 ? 'مادة' : 'مواد'} قليلة المخزون
              </h3>
